...
exports.help = {
    ...
    usage: `streamlink <option> [possible arguments go here]\n\n<option> needs to be given and can be (enable|disable|add|remove|status|help)\n\nThe [possible arguments] depend entirely on what <option> you are attempting to use. Refer to "${settings.prefix}streamlink help" for more information, or for more information a specific <option> use "${settings.prefix}streamlink <option> help", replacing <option> accordingly.`
};